...
function mqCheck() {
    if (!$("html").hasClass("lt-ie9")) switch (!0) {
      case 767 >= mediaQuery:
        mq = "xs";
        break;

      case mediaQuery >= 768 && 991 >= mediaQuery:
        mq = "sm";
        break;

      case mediaQuery >= 992 && 1199 >= mediaQuery:
        mq = "md";
        break;

      case mediaQuery >= 1200 && 1600 >= mediaQuery:
        mq = "lg";
        break;
...
function mobileNavInit() {
    jQuery("#mobileNav").click(function() {
        jQuery(this).toggleClass("active"), jQuery("body").toggleClass("active");
    }), jQuery("#navWrap a").click(function() {
        jQuery("#mobileNav").removeClass("active"), jQuery("body").removeClass("active");
    });
}
...
if (!function(a, b) {
    ...
    function E(a, b, c) {
        ...
        return A(b, "string") || A(b, "undefined") ? C(e, b) : (e = (a + " " + o.join(d + " ") + d).split(" "), 
        D(e, b, c));
    }
    var k, v, x, d = "2.6.2", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, m = ({}.toString, 
    "Webkit Moz O ms"), n = m.split(" "), o = m.toLowerCase().split(" "), p = {
        svg: "http://www.w3.org/2000/svg"
    }, q = {}, t = [], u = t.slice, w = {}.hasOwnProperty;
    x = A(w, "undefined") || A(w.call, "undefined") ? function(a, b) {
    ...
    return e.addTest = function(a, b) {
        if ("object" == typeof a) for (var d in a) x(a, d) && e.addTest(d, a[d]); else {
            if (a = a.toLowerCase(), e[a] !== c) return e;
            b = "function" == typeof b ? b() : b, "undefined" != typeof f && f && (g.className += " " + (b ? "" : "no-") + a), 
            e[a] = b;
        }
        return e;
    }, y(""), i = k = null, e._version = d, e._domPrefixes = o, e._cssomPrefixes = n, 
    ...
    function v(a) {
        for (var b, c = a.getElementsByTagName("*"), d = c.length, e = RegExp("^(?:" + l().join("|") + ")$", "i"), f = []; d--; ) b = c[d], 
        e.test(b.nodeName) && f.push(b.applyElement(w(b)));
        return f;
    }
    function w(a) {
        for (var b, c = a.attributes, d = c.length, e = a.ownerDocument.createElement(t + ":" + a.nodeName); d--; ) b = c[d], 
        b.specified && e.setAttribute(b.nodeName, b.nodeValue);
        return e.style.cssText = a.style.cssText, e;
    }
    function x(a) {
        for (var b, c = a.split("{"), d = c.length, e = RegExp("(^|[\\s,>+~])(" + l().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), f = "$1" + t + "\\:$2"; d--; ) b = c[d] = c[d].split("}"), 
        b[b.length - 1] = b[b.length - 1].replace(e, f), c[d] = b.join("}");
        return c.join("{");
    }
    function y(a) {
    ...
    function z(a) {
        ...
        return !u || a.printShived ? a : ("undefined" == typeof e[t] && e.add(t), f.attachEvent("onbeforeprint", function() {
            g();
            for (var d, e, f, h = a.styleSheets, i = [], j = h.length, l = Array(j); j--; ) l[j] = h[j];
            for (;f = l.pop(); ) if (!f.disabled && s.test(f.media)) {
                try {
                    d = f.imports, e = d.length;
                } catch (m) {
                    e = 0;
                }
                for (j = 0; e > j; j++) l.push(d[j]);
                try {
                    i.push(f.cssText);
                } catch (m) {}
            }
...
}(this, document), function(T, V, s) {
    "use strict";
    function t(b) {
        return function() {
            var c, a = arguments[0], a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.18/" + (b ? b + "/" : "") + a;
    ...
    function db(b) {
        ...
        var a = b.length;
        return 1 === b.nodeType && a ? !0 : C(b) || O(b) || 0 === a || "number" == typeof a && a > 0 && a - 1 in b;
    }
    function q(b, a, c) {
        var d;
    ...
    function eb() {
        for (var a, b = ja.length; b; ) {
            if (b--, a = ja[b].charCodeAt(0), 57 == a) return ja[b] = "A", ja.join("");
            if (90 != a) return ja[b] = String.fromCharCode(a + 1), ja.join("");
            ja[b] = "0";
        }
        return ja.unshift("0"), ja.join("");
    }
    function Yb(b, a) {
    ...
    function Ga(b, a, c, d) {
        ...
        if (a) {
            ...
            if (O(b)) for (var g = a.length = 0; g < b.length; g++) e = Ga(b[g], null, c, d), 
            U(b[g]) && (c.push(b[g]), d.push(e)), a.push(e); else {
                var f = a.$$hashKey;
                q(a, function(b, c) {
                    delete a[c];
                });
    ...
    function xa(b, a) {
        ...
        if (c == typeof a && "object" == c) {
            if (!O(b)) {
                ...
                if (b && b.$evalAsync && b.$watch || a && a.$evalAsync && a.$watch || Ea(b) || Ea(a) || O(a)) return !1;
                c = {};
    ...
    function Vc(b, a) {
        var c = a;
        return "string" == typeof b && "$" === b.charAt(0) ? c = s : Ea(a) ? c = "$WINDOW" : a && V === a ? c = "$DOCUMENT" : a && a.$evalAsync && a.$watch && (c = "$SCOPE"), 
        c;
    }
    function ra(b, a) {
    ...
    function Ra(b) {
        return "function" == typeof b ? b = !0 : b && 0 !== b.length ? (b = L("" + b), b = !("f" == b || "0" == b || "false" == b || "no" == b || "n" == b || "[]" == b)) : b = !1, 
        b;
    }
    function ga(b) {
        b = w(b).clone();
    ...
    function Wc(b, a) {
        ...
        var e, g, d = [ b ], f = [ "ng:app", "ng-app", "x-ng-app", "data-ng-app" ], k = /\sng[:\-]app(:\s*([\w\d_]+);?)?\s/;
        q(f, function(a) {
            f[a] = !0, c(V.getElementById(a)), a = a.replace(":", "\\:"), b.querySelectorAll && (q(b.querySelectorAll("." + a), c), 
    ...
    function dc(b, a) {
        var c = function() {
            ...
            } ]), a.unshift("ng"), c = ec(a), c.invoke([ "$rootScope", "$rootElement", "$compile", "$injector", "$animate", function(a, b, c, d, e) {
                a.$apply(function() {
                    b.data("$injector", d), c(b)(a);
                });
            } ]), c;
        }, d = /^NG_DEFER_BOOTSTRAP!/;
        return T && !d.test(T.name) ? c() : (T.name = T.name.replace(d, ""), void (Sa.resumeBootstrap = function(b) {
            q(b, function(b) {
                a.push(b);
            }), c();
        }));
    ...
    function Ta(b, a, c) {
        return c && O(b) && (b = b[b.length - 1]), Cb(Q(b), a, "not a function, got " + (b && "object" == typeof b ? b.constructor.name || "Object" : typeof b)), 
        b;
    }
    function Aa(b, a) {
    ...
    function Zc(b) {
        ...
        Ua("ng", [ "ngLocale" ], [ "$provide", function(a) {
            a.provider({
                ...
                ngInclude: Jd
            }).directive(Eb).directive(jc), a.provider({
                $anchorScroll: Kd,
                $animate: Ld,
                $browser: Md,
                $cacheFactory: Nd,
    ...
    function Fb(b, a, c, d) {
        function e(b) {
            var h, l, n, p, r, v, e = c && b ? [ this.filter(b) ] : [ this ], m = a;
            if (!d || null != b) for (;e.length; ) for (h = e.shift(), l = 0, n = h.length; n > l; l++) for (p = w(h[l]), 
            m ? p.triggerHandler("$destroy") : m = !m, r = 0, p = (v = p.children()).length; p > r; r++) e.push(Ba(v[r]));
            return g.apply(this, arguments);
        }
        var g = Ba.fn[b], g = g.$original || g;
        e.$original = g, Ba.fn[b] = e;
    }
    function R(b) {
        if (b instanceof R) return b;
        if (C(b) && (b = aa(b)), !(this instanceof R)) {
        ...
        if (C(b)) {
            ...
            if (c = je.exec(a)) b = [ b.createElement(c[1]) ]; else {
                var e, d = b;
                if (b = d.createDocumentFragment(), c = [], Hb.test(a)) {
    ...
    function lc(b, a) {
        ...
        mc(b)), delete Xa[c], b[ib] = s));
    }
    function la(b, a, c) {
        var d = b[ib], d = Xa[d || -1];
        return B(c) ? (d || (b[ib] = d = ++me, d = Xa[d] = {}), void (d[a] = c)) : d && d[a];
    }
    function nc(b, a, c) {
    ...
    function lb(b, a, c) {
        for (b = w(b), 9 == b[0].nodeType && (b = b.find("html")), a = O(a) ? a : [ a ]; b.length; ) {
    ...
    function ne(b, a) {
        var c = function(c, e) {
            if (c.preventDefault || (c.preventDefault = function() {
                ...
                c.cancelBubble = !0;
            }), c.target || (c.target = c.srcElement || V), D(c.defaultPrevented)) {
    ...
    function Ja(b) {
        var c, a = typeof b;
        return "object" == a && null !== b ? "function" == typeof (c = b.$$hashKey) ? c = b.$$hashKey() : c === s && (c = b.$$hashKey = eb()) : c = b, 
        a + ":" + c;
    }
    function Ya(b) {
        q(b, this.put, this);
    ...
    function ec(b) {
        function a(a) {
            return function(b, c) {
                return U(b) ? void q(b, Xb(a)) : a(b, c);
            };
        }
        function c(a, b) {
            if (Aa(a, "service"), (Q(b) || O(b)) && (b = n.instantiate(b)), !b.$get) throw Za("pget", a);
            return l[a + k] = b;
        }
        function d(a, b) {
            return c(a, {
        ...
        function e(a) {
            ...
            return q(a, function(a) {
                if (!h.get(a)) {
                    h.put(a, !0);
                    try {
                        if (C(a)) for (c = Ua(a), b = b.concat(e(c.requires)).concat(c._runBlocks), d = c._invokeQueue, 
                        g = 0, k = d.length; k > g; g++) {
                        ...
                        Za("modulerr", a, l.stack || l.message || l);
                    }
                }
            }), b;
        }
        function g(a, b) {
            ...
            function d(a, b, e) {
                var f, m, h, g = [], k = sc(a);
                for (m = 0, f = k.length; f > m; m++) {
                    if (h = k[m], "string" != typeof h) throw Za("itkn", h);
            ...
            return {
                ...
                instantiate: function(a, b) {
                    var e, c = function() {};
                    return c.prototype = (O(a) ? a[a.length - 1] : a).prototype, c = new c(), e = d(a, c, b), 
                    U(e) || Q(e) ? e : c;
                },
                get: c,
                annotate: sc,
        ...
        var f = {}, k = "Provider", m = [], h = new Ya(), l = {
            ...
            return a = n.get(a + k), r.invoke(a.$get, a);
        });
    ...
    function se(b, a, c, d) {
        ...
        function f() {
            z = null, M != k.url() && (M = k.url(), q(ha, function(a) {
                a(k.url());
            }));
        }
        ...
        k.addPollFn = function(a) {
            return D(u) && g(100, n), x.push(a), a;
        };
        var M = h.href, F = a.find("base"), z = null;
        k.url = function(a, c) {
            return h !== b.location && (h = b.location), l !== b.history && (l = b.history), 
            a ? M != a ? (M = a, d.history ? c ? l.replaceState(null, "", a) : (l.pushState(null, "", a), 
            F.attr("href", F.attr("href"))) : (z = a, c ? h.replace(a) : h.href = a), k) : void 0 : z || h.href.replace(/%27/g, "'");
        };
        var ha = [], P = !1;
        k.onUrlChange = function(a) {
            return P || (d.history && w(b).on("popstate", f), d.hashchange ? w(b).on("hashchange", f) : k.addPollFn(f), 
            P = !0), ha.push(a), a;
        }, k.baseHref = function() {
            var a = F.attr("href");
        ...
        k.cookies = function(a, b) {
            var d, e, g, k;
            if (!a) {
                if (m.cookie !== ca) for (ca = m.cookie, d = ca.split("; "), N = {}, g = 0; g < d.length; g++) e = d[g], 
                k = e.indexOf("="), k > 0 && (a = unescape(e.substring(0, k)), N[a] === s && (N[a] = unescape(e.substring(k + 1))));
                return N;
            }
            b === s ? m.cookie = escape(a) + "=;path=" + E + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : C(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + E).length + 1, 
            d > 4096 && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
        }, k.defer = function(a, b) {
            var c;
            return v++, c = n(function() {
                delete r[c], e(a);
            }, b || 0), r[c] = !0, c;
            ...
            function b(b, d) {
                ...
                return a[b] = {
                    put: function(a, b) {
                        ...
                        return D(b) ? void 0 : (a in m || f++, m[a] = b, f > h && this.remove(p.key), b);
                    },
                    get: function(a) {
                        if (h < Number.MAX_VALUE) {
                            var b = l[a];
                    ...
                    remove: function(a) {
                        if (h < Number.MAX_VALUE) {
                            var b = l[a];
                            if (!b) return;
                            b == n && (n = b.p), b == p && (p = b.n), g(b.n, b.p), delete l[a];
                        }
                        delete m[a], f--;
                    },
                    removeAll: function() {
    ...
    function gc(b, a) {
        ...
        this.directive = function m(a, e) {
            return Aa(a, "directive"), C(a) ? (Cb(e, "directiveFactory"), c.hasOwnProperty(a) || (c[a] = [], 
            b.factory(a + d, [ "$injector", "$exceptionHandler", function(b, d) {
                ...
                return q(c[a], function(c, g) {
                    try {
                        ...
                        Q(f) ? f = {
                            compile: $(f)
                        } : !f.compile && f.link && (f.compile = $(f.link)), f.priority = f.priority || 0, 
            ...
            function P(a, b, c, d, e, g) {
                function f(a, c, d, e) {
                    ...
                    g = c.length;
                    var K = Array(g);
                    for (n = 0; g > n; n++) K[n] = c[n];
                    for (v = n = 0, p = m.length; p > n; v++) h = K[v], c = m[n++], g = m[n++], l = w(h), 
                    c ? (c.scope ? (r = a.$new(), l.data("$scope", r)) : r = a, l = c.transcludeOnThisElement ? N(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? N(a, b) : null, 
                    c(g, r, h, d, l)) : g && g(a, h.childNodes, s, e);
                }
                for (var h, l, r, n, m = [], p = 0; p < a.length; p++) h = new Lb(), l = ca(a[p], [], h, 0 === p ? d : s, e), 
                (g = l.length ? H(l, a[p], h, b, c, null, [], [], g) : null) && g.scope && ha(w(a[p]), "ng-scope"), 
                h = g && g.terminal || !(r = a[p].childNodes) || !r.length ? null : P(r, g ? (g.transcludeOnThisElement || !g.templateOnThisElement) && g.transclude : b), 
                m.push(g, h), n = n || g || h, g = null;
                return n ? f : null;
            }
            function N(a, b, c) {
                return function(d, e, g) {
                    var f = !1;
                    return d || (d = a.$new(), f = d.$$transcluded = !0), e = b(d, e, g, c), f && e.on("$destroy", function() {
                        d.$destroy();
                    }), e;
                };
            }
            function ca(a, b, c, d, f) {
                ...
                switch (a.nodeType) {
                  case 1:
                    ...
                    var l, r, n;
                    h = a.attributes;
                    for (var p = 0, v = h && h.length; v > p; p++) {
                        var x = !1, I = !1;
                        if (l = h[p], !S || S >= 8 || l.specified) {
                            r = l.name, n = ma(r), W.test(n) && (r = hb(n.substr(6), "-"));
                            var M = n.replace(/(Start|End)$/, "");
                            n === M + "Start" && (x = r, I = r.substr(0, r.length - 5) + "end", r = r.substr(0, r.length - 6)), 
                            n = ma(r.toLowerCase()), m[n] = r, c[n] = l = aa(l.value), qc(a, n) && (c[n] = !0), 
                            R(a, b, l, n), ba(b, n, "A", d, f, x, I);
                        }
                    }
                    if (a = a.className, C(a) && "" !== a) for (;h = g.exec(a); ) n = ma(h[2]), ba(b, n, "C", d, f) && (c[n] = aa(h[3])), 
                  ...
                  case 8:
                    try {
                        (h = e.exec(a.nodeValue)) && (n = ma(h[1]), ba(b, n, "M", d, f) && (c[n] = aa(h[2])));
                    } catch (u) {}
                }
                return b.sort(D), b;
            }
            ...
            function A(a, b, c) {
                return function(d, e, g, f, h) {
                    return e = E(e[0], b, c), a(d, e, g, f, h);
                };
            }
            function H(a, c, d, e, g, f, m, n, p) {
                function x(a, b, c, d) {
                    a && (c && (a = A(a, c, d)), a.require = G.require, a.directiveName = na, (N === G || G.$$isolateScope) && (a = uc(a, {
                        isolateScope: !0
                    })), m.push(a)), b && (c && (b = A(b, c, d)), b.require = G.require, b.directiveName = na, 
                    (N === G || G.$$isolateScope) && (b = uc(b, {
                        isolateScope: !0
                    })), n.push(b));
                }
                function I(a, b, c, d) {
                ...
                function M(a, e, g, f, p) {
                    function x(a, b) {
                        var c;
                        return 2 > arguments.length && (b = a, a = s), Ca && (c = ca), p(a, b, c);
                    }
                    var u, K, z, F, A, E, nb, ca = {};
                    if (u = c === g ? d : ka(d, new Lb(w(g), d.$attr)), K = u.$$element, N) {
                        var ba = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
                        f = w(g), E = e.$new(!0), !H || H !== N && H !== N.$$originalDirective ? f.data("$isolateScopeNoTemplate", E) : f.data("$isolateScope", E), 
                        ha(f, "ng-isolate-scope"), q(N.scope, function(a, c) {
                            var m, l, n, p, d = a.match(ba) || [], g = d[3] || c, f = "?" == d[2], d = d[1];
                            switch (E.$$isolateBindings[c] = d + g, d) {
                              case "@":
                                u.$observe(g, function(a) {
                                    E[c] = a;
                                }), u.$$observers[g].$$scope = e, u[g] && (E[c] = b(u[g])(e));
                                break;

                              case "=":
                                if (f && !u[g]) break;
                                l = r(u[g]), p = l.literal ? xa : function(a, b) {
                                    return a === b;
                                }, n = l.assign || function() {
                                    throw m = E[c] = l(e), ia("nonassign", u[g], N.name);
                                }, m = E[c] = l(e), E.$watch(function() {
                                    var a = l(e);
                                    return p(a, E[c]) || (p(a, m) ? n(e, a = E[c]) : E[c] = a), m = a;
                                }, null, l.literal);
                                break;

                              case "&":
                                l = r(u[g]), E[c] = function(a) {
                                    return l(e, a);
                                };
                                break;
                    ...
                    for (nb = p && x, P && q(P, function(a) {
                        ...
                        A = a.controller, "@" == A && (A = u[a.name]), c = v(A, b), ca[a.name] = c, Ca || K.data("$" + a.name + "Controller", c), 
                        a.controllerAs && (b.$scope[a.controllerAs] = c);
                    }), f = 0, z = m.length; z > f; f++) try {
                        (F = m[f])(F.isolateScope ? E : e, K, u, F.require && I(F.directiveName, F.require, K, ca), nb);
                    } catch (G) {
                        l(G, ga(K));
                    }
                    for (f = e, N && (N.template || null === N.templateUrl) && (f = E), a && a(f, g.childNodes, s, p), 
                    f = n.length - 1; f >= 0; f--) try {
                        (F = n[f])(F.isolateScope ? E : e, K, u, F.require && I(F.directiveName, F.require, K, ca), nb);
                    } catch (B) {
                        l(B, ga(K));
                    }
                }
                p = p || {};
                for (var F, G, na, X, R, u = -Number.MAX_VALUE, P = p.controllerDirectives, N = p.newIsolateScopeDirective, H = p.templateDirective, ba = p.nonTlbTranscludeDirective, D = !1, J = !1, Ca = p.hasElementTranscludeDirective, t = d.$$element = w(c), T = e, S = 0, oa = a.length; oa > S; S++) {
                    G = a[S];
                    var W = G.$$start, Y = G.$$end;
                    if (W && (t = E(c, W, Y)), X = s, u > G.priority) break;
                    if ((X = G.scope) && (F = F || G, G.templateUrl || (L("new/isolated scope", N, G, t), 
                    U(X) && (N = G))), na = G.name, !G.templateUrl && G.controller && (X = G.controller, 
                    P = P || {}, L("'" + na + "' controller", P[na], G, t), P[na] = G), (X = G.transclude) && (D = !0, 
                    G.$$tlb || (L("transclusion", ba, G, t), ba = G), "element" == X ? (Ca = !0, u = G.priority, 
                    X = E(c, W, Y), t = d.$$element = w(V.createComment(" " + na + ": " + d[na] + " ")), 
                    c = t[0], ob(g, w(ya.call(X, 0)), c), T = z(X, e, u, f && f.name, {
                        nonTlbTranscludeDirective: ba
                    })) : (X = w(Jb(c)).contents(), t.empty(), T = z(X, e))), G.template) if (J = !0, 
                    L("template", H, G, t), H = G, X = Q(G.template) ? G.template(t, d) : G.template, 
                    X = Z(X), G.replace) {
                        if (f = G, X = Hb.test(X) ? w(aa(X)) : [], c = X[0], 1 != X.length || 1 !== c.nodeType) throw ia("tplrt", na, "");
                        ob(g, t, c), oa = {
                            $attr: {}
                        }, X = ca(c, [], oa);
                        var te = a.splice(S + 1, a.length - (S + 1));
                        N && tc(X), a = a.concat(X).concat(te), B(d, oa), oa = a.length;
                    } else t.html(X);
                    if (G.templateUrl) J = !0, L("template", H, G, t), H = G, G.replace && (f = G), 
                    M = y(a.splice(S, a.length - S), t, d, g, D && T, m, n, {
                ...
                return M.scope = F && !0 === F.scope, M.transcludeOnThisElement = D, M.templateOnThisElement = J, 
                M.transclude = T, p.hasElementTranscludeDirective = Ca, M;
            }
            function tc(a) {
                for (var b = 0, c = a.length; c > b; b++) a[b] = Zb(a[b], {
                    $$isolateScope: !0
                });
            }
            function ba(b, e, g, f, h, r, n) {
                ...
                if (h = null, c.hasOwnProperty(e)) {
                    var p;
                    e = a.get(e + d);
                    for (var v = 0, x = e.length; x > v; v++) try {
            ...
            function y(a, b, c, d, e, g, f, h) {
                var l, r, m = [], v = b[0], x = a.shift(), I = J({}, x, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: x
                }), M = Q(x.templateUrl) ? x.templateUrl(b, c) : x.templateUrl;
                return b.empty(), n.get(u.getTrustedResourceUrl(M), {
                    cache: p
                }).success(function(n) {
                    var p, u;
                    if (n = Z(n), x.replace) {
                        if (n = Hb.test(n) ? w(aa(n)) : [], p = n[0], 1 != n.length || 1 !== p.nodeType) throw ia("tplrt", x.name, M);
                        n = {
                            $attr: {}
                        }, ob(d, b, p);
                        var z = ca(p, [], n);
                        U(x.scope) && tc(z), a = z.concat(a), B(c, n);
                    } else p = v, b.html(n);
                    for (a.unshift(I), l = H(a, p, c, e, b, x, g, f, h), q(d, function(a, c) {
                        a == p && (d[c] = b[0]);
                    }), r = P(b[0].childNodes, e); m.length; ) {
                        n = m.shift(), u = m.shift();
                        var F = m.shift(), A = m.shift(), z = b[0];
                        if (u !== v) {
                            var E = u.className;
                            h.hasElementTranscludeDirective && x.replace || (z = Jb(p)), ob(F, w(u), z), ha(w(z), E);
                        }
                        u = l.transcludeOnThisElement ? N(n, l.transclude, A) : A, l(r, n, z, d, u);
                    }
                    m = null;
                }).error(function(a, b, c, d) {
                    throw ia("tpload", d.url);
                }), function(a, b, c, d, e) {
                    a = e, m ? (m.push(b), m.push(c), m.push(d), m.push(a)) : (l.transcludeOnThisElement && (a = N(b, l.transclude, e)), 
                    l(r, b, c, d, a));
                };
            }
            function D(a, b) {
            ...
            function t(a, c) {
                ...
                d && a.push({
                    ...
                    compile: function(a) {
                        ...
                        return b && ha(a.parent(), "ng-binding"), function(a, c) {
                            var e = c.parent(), g = e.data("$binding") || [];
                            g.push(d), e.data("$binding", g), b || ha(e, "ng-binding"), a.$watch(d, function(a) {
                                c[0].nodeValue = a;
                            });
                        };
                    }
                ...
                if (g) {
                    ...
                    c.push({
                        ...
                        compile: function() {
                            return {
                                pre: function(c, d, m) {
                                    if (d = m.$$observers || (m.$$observers = {}), f.test(e)) throw ia("nodomevents");
                                    (g = b(m[e], !0, T(a, e))) && (m[e] = g(c), (d[e] || (d[e] = [])).$$inter = !0, 
            ...
            function ob(a, b, c) {
                var f, m, d = b[0], e = b.length, g = d.parentNode;
                if (a) for (f = 0, m = a.length; m > f; f++) if (a[f] == d) {
                    a[f++] = c, m = f + e - 1;
                    for (var h = a.length; h > f; f++, m++) h > m ? a[f] = a[m] : delete a[f];
                    a.length -= e - 1;
                    break;
                }
                for (g && g.replaceChild(c, d), a = V.createDocumentFragment(), a.appendChild(d), 
                c[w.expando] = d[w.expando], d = 1, e = b.length; e > d; d++) g = b[d], w(g).remove(), 
            ...
            Lb.prototype = {
                ...
                $set: function(a, b, c, d) {
                    ...
                    e && (this.$$element.prop(a, b), d = e), this[a] = b, d ? this.$attr[a] = d : (d = this.$attr[a]) || (this.$attr[a] = d = hb(a, "-")), 
                    e = La(this.$$element), ("A" === e && "href" === a || "IMG" === e && "src" === a) && (this[a] = b = F(b, "src" === a)), 
                ...
                $observe: function(a, b) {
                    ...
                    return e.push(b), I.$evalAsync(function() {
                        e.$$inter || b(c[a]);
                    }), b;
                }
            };
    ...
    function Od() {
        ...
        this.register = function(a, d) {
            Aa(a, "controller"), U(a) ? J(b, a) : b[a] = d;
        }, this.$get = [ "$injector", "$window", function(c, d) {
            return function(e, g) {
                var f, k, m;
                if (C(e) && (f = e.match(a), k = f[1], m = f[3], e = b.hasOwnProperty(k) ? b[k] : fc(g.$scope, k, !0) || fc(d, k, !0), 
                Ta(e, k, !0)), f = c.instantiate(e, g), m) {
    ...
    function wc(b) {
        var c, d, e, a = {};
        return b ? (q(b.split("\n"), function(b) {
            e = b.indexOf(":"), c = L(aa(b.substr(0, e))), d = aa(b.substr(e + 1)), c && (a[c] = a[c] ? a[c] + (", " + d) : d);
        }), a) : a;
    }
    function xc(b) {
        var a = U(b) ? b : s;
        return function(c) {
            return a || (a = wc(b)), c ? a[L(c)] || null : a;
        };
    }
    function yc(b, a, c) {
        return Q(c) ? c(b, a) : (q(c, function(c) {
            b = c(b, a);
        }), b);
    }
    function Td() {
        var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = {
            ...
            transformResponse: [ function(d) {
                return C(d) && (d = d.replace(c, ""), b.test(d) && a.test(d) && (d = ac(d))), d;
            } ],
        ...
        this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, b, c, d, n, p) {
            function r(a) {
                function b(a) {
                    var d = J({}, a, {
                        data: yc(a.data, a.headers, c.transformResponse)
                    });
                ...
                var c = {
                    ...
                    var g, f, c = e.headers, d = J({}, a.headers), c = J({}, c.common, c[L(a.method)]);
                    b(c), b(d);
                    a: for (g in c) {
                        a = L(g);
                ...
                J(c, a), c.headers = d, c.method = Ha(c.method);
                var g = [ function(a) {
                    d = a.headers;
                    var c = yc(a.data, xc(d), a.transformRequest);
                    return D(a.data) && q(d, function(a, b) {
            ...
            function v(c, g, f) {
                function h(a, b, c, e) {
                    A && (a >= 200 && 300 > a ? A.put(w, [ a, b, wc(c), e ]) : A.remove(w)), p(b, a, c, e), 
                    d.$$phase || d.$apply();
                }
                function p(a, b, d, e) {
                ...
                var A, H, u = n.defer(), q = u.promise, w = I(c.url, c.params);
                if (r.pendingRequests.push(c), q.then(v, v), (c.cache || e.cache) && !1 !== c.cache && "GET" == c.method && (A = U(c.cache) ? c.cache : U(e.cache) ? e.cache : x), 
                A) if (H = A.get(w), B(H)) {
                    if (H.then) return H.then(v, v), H;
                    O(H) ? p(H[1], H[0], ka(H[2]), H[3]) : p(H, 200, {}, "OK");
                } else A.put(w, q);
                return D(H) && ((H = Mb(c.url) ? b.cookies()[c.xsrfCookieName || e.xsrfCookieName] : s) && (f[c.xsrfHeaderName || e.xsrfHeaderName] = H), 
                a(c.method, w, g, h, f, c.timeout, c.withCredentials, c.responseType)), q;
            }
            function I(a, b) {
                if (!b) return a;
                var c = [];
    ...
    function we(b, a, c, d, e) {
        function g(a, b, c) {
            ...
            return g.type = "text/javascript", g.src = a, g.async = !0, f = function(a) {
                Wa(g, "load", f), Wa(g, "error", f), e.body.removeChild(g), g = null;
                var k = -1, v = "unknown";
                a && ("load" !== a.type || d[b].called || (a = {
                    type: "error"
                }), v = a.type, k = "error" === a.type ? 404 : 200), c && c(k, v);
            }, pb(g, "load", f), pb(g, "error", f), 8 >= S && (g.onreadystatechange = function() {
                C(g.readyState) && /loaded|complete/.test(g.readyState) && (g.onreadystatechange = null, 
                f({
                    type: "load"
                }));
            }), e.body.appendChild(g), f;
        }
        var f = -1;
        return function(e, m, h, l, n, p, r, v) {
            ...
            function x(a, d, e, g, f) {
                P && c.cancel(P), F = z = null, 0 === d && (d = e ? 200 : "file" == sa(m).protocol ? 404 : 0), 
                a(1223 === d ? 204 : d, e, g, f || ""), b.$$completeOutstandingRequest(y);
            }
            var u;
            if (b.$$incOutstandingRequestCount(), m = m || b.url(), "jsonp" == L(e)) {
                var M = "_" + (d.counter++).toString(36);
                d[M] = function(a) {
                    d[M].data = a, d[M].called = !0;
                };
                var F = g(m.replace("JSON_CALLBACK", "angular.callbacks." + M), M, function(a, b) {
                    x(l, a, d[M].data, "", b), d[M] = y;
                });
            } else {
                var z = a(e);
                if (z.open(e, m, !0), q(n, function(a, b) {
            ...
            if (p > 0) var P = c(I, p); else p && p.then && p.then(I);
        };
    }
    function Rd() {
        var b = "{{", a = "}}";
        this.startSymbol = function(a) {
            ...
            function g(g, h, l) {
                for (var n, p, r = 0, v = [], I = g.length, x = !1, u = []; I > r; ) -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f)) ? (r != n && v.push(g.substring(r, n)), 
                v.push(r = c(x = g.substring(n + f, p))), r.exp = x, r = p + k, x = !0) : (r != I && v.push(g.substring(r)), 
                r = I);
                if ((I = v.length) || (v.push(""), I = 1), l && 1 < v.length) throw zc("noconcat", g);
                return !h || x ? (u.length = I, r = function(a) {
                    try {
                        for (var f, b = 0, c = I; c > b; b++) {
                            if ("function" == typeof (f = v[b])) if (f = f(a), f = l ? e.getTrusted(l, f) : e.valueOf(f), 
                            null == f) f = ""; else switch (typeof f) {
                              case "string":
                                break;
    ...
    function Sd() {
        this.$get = [ "$rootScope", "$window", "$q", function(b, a, c) {
            function d(d, f, k, m) {
                ...
                return k = B(k) ? k : 0, p.then(null, null, d), p.$$intervalId = h(function() {
                    n.notify(r++), k > 0 && r >= k && (n.resolve(r), l(p.$$intervalId), delete e[p.$$intervalId]), 
                    v || b.$apply();
    ...
    function Ac(b, a, c) {
        b = sa(b, c), a.$$protocol = b.protocol, a.$$host = b.hostname, a.$$port = Z(b.port) || xe[b.protocol] || null;
    }
    function Bc(b, a, c) {
        var d = "/" !== b.charAt(0);
    ...
    function Cc(b, a) {
        this.$$html5 = !0, a = a || "";
        var c = Ob(b);
        Ac(b, this, b), this.$$parse = function(a) {
            var e = pa(c, a);
            if (!C(e)) throw Pb("ipthprfx", a, c);
            Bc(e, this, b), this.$$path || (this.$$path = "/"), this.$$compose();
        }, this.$$compose = function() {
            var a = Bb(this.$$search), b = this.$$hash ? "#" + gb(this.$$hash) : "";
            this.$$url = Nb(this.$$path) + (a ? "?" + a : "") + b, this.$$absUrl = c + this.$$url.substr(1);
        }, this.$$rewrite = function(d) {
            var e;
            return (e = pa(b, d)) !== s ? (d = e, (e = pa(a, e)) !== s ? c + (pa("/", e) || e) : b + d) : (e = pa(c, d)) !== s ? c + e : c == d + "/" ? c : void 0;
        };
    }
    function Qb(b, a) {
        var c = Ob(b);
        Ac(b, this, b), this.$$parse = function(d) {
            var e = pa(b, d) || pa(c, d), e = "#" == e.charAt(0) ? pa(a, e) : this.$$html5 ? e : "";
            if (!C(e)) throw Pb("ihshprfx", d, a);
            Bc(e, this, b), d = this.$$path;
            var g = /^\/[A-Z]:(\/.*)/;
            ...
            this.$$url = Nb(this.$$path) + (c ? "?" + c : "") + e, this.$$absUrl = b + (this.$$url ? a + this.$$url : "");
        }, this.$$rewrite = function(a) {
            return $a(b) == $a(a) ? a : void 0;
        };
    }
    function Rb(b, a) {
        this.$$html5 = !0, Qb.apply(this, arguments);
        var c = Ob(b);
        this.$$rewrite = function(d) {
            var e;
            return b == $a(d) ? d : (e = pa(c, d)) ? b + a + e : c === d + "/" ? c : void 0;
        }, this.$$compose = function() {
            var c = Bb(this.$$search), e = this.$$hash ? "#" + gb(this.$$hash) : "";
            this.$$url = Nb(this.$$path) + (c ? "?" + c : "") + e, this.$$absUrl = b + a + this.$$url;
        };
    }
    function qb(b) {
        return function() {
    ...
    function Vd() {
        ...
        this.hashPrefix = function(a) {
            ...
            var k, m, n, h = d.baseHref(), l = d.url();
            a ? (n = l.substring(0, l.indexOf("/", l.indexOf("//") + 2)) + (h || "/"), m = e.history ? Cc : Rb) : (n = $a(l), 
            m = Qb), k = new m(n, "#" + b), k.$$parse(k.$$rewrite(l)), g.on("click", function(a) {
                if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                    for (var e = w(a.target); "a" !== L(e[0].nodeName); ) if (e[0] === g[0] || !(e = e.parent())[0]) return;
                    var f = e.prop("href");
                    if (U(f) && "[object SVGAnimatedString]" === f.toString() && (f = sa(f.animVal).href), 
                    m === Rb) {
                    ...
                    l = k.$$rewrite(f), f && !e.attr("target") && l && !a.isDefaultPrevented() && (a.preventDefault(), 
                    l != d.url() && (k.$$parse(l), c.$apply(), T.angular["ff-684208-preventDefault"] = !0));
                }
            }), k.absUrl() != l && d.url(k.absUrl(), !0), d.onUrlChange(function(a) {
                k.absUrl() != a && (c.$evalAsync(function() {
                    var b = k.absUrl();
                    k.$$parse(a), c.$broadcast("$locationChangeStart", a, b).defaultPrevented ? (k.$$parse(b), 
                    d.url(b)) : f(b);
                }), c.$$phase || c.$digest());
            });
            var p = 0;
            return c.$watch(function() {
                ...
                return p && a == k.absUrl() || (p++, c.$evalAsync(function() {
    ...
    function rb(b, a, c, d, e) {
        ...
        for (var g, f = 0; 1 < a.length; f++) {
            g = ea(a.shift(), d);
            var k = b[g];
            k || (k = {}, b[g] = k), b = k, b.then && e.unwrapPromises && (ta(d), "$$v" in b || function(a) {
                a.then(function(b) {
                    a.$$v = b;
                });
            }(b), b.$$v === s && (b.$$v = {}), b = b.$$v);
        }
        return g = ea(a.shift(), d), b[g] = c;
    }
    function Ec(b, a, c, d, e, g, f) {
        return ea(b, g), ea(a, g), ea(c, g), ea(d, g), ea(e, g), f.unwrapPromises ? function(f, m) {
            var l, h = m && m.hasOwnProperty(b) ? m : f;
            return null == h ? h : ((h = h[b]) && h.then && (ta(g), "$$v" in h || (l = h, l.$$v = s, 
            l.then(function(a) {
                l.$$v = a;
            })), h = h.$$v), a ? null == h ? s : ((h = h[a]) && h.then && (ta(g), "$$v" in h || (l = h, 
            l.$$v = s, l.then(function(a) {
                l.$$v = a;
            })), h = h.$$v), c ? null == h ? s : ((h = h[c]) && h.then && (ta(g), "$$v" in h || (l = h, 
            l.$$v = s, l.then(function(a) {
                l.$$v = a;
            })), h = h.$$v), d ? null == h ? s : ((h = h[d]) && h.then && (ta(g), "$$v" in h || (l = h, 
            l.$$v = s, l.then(function(a) {
                l.$$v = a;
            })), h = h.$$v), e ? null == h ? s : ((h = h[e]) && h.then && (ta(g), "$$v" in h || (l = h, 
            l.$$v = s, l.then(function(a) {
                l.$$v = a;
            })), h = h.$$v), h) : h) : h) : h) : h);
        } : function(g, f) {
            var h = f && f.hasOwnProperty(b) ? f : g;
            return null == h ? h : (h = h[b], a ? null == h ? s : (h = h[a], c ? null == h ? s : (h = h[c], 
            d ? null == h ? s : (h = h[d], e ? null == h ? s : h = h[e] : h) : h) : h) : h);
        };
    }
    function ye(b, a) {
        return ea(b, a), function(a, d) {
            return null == a ? s : (d && d.hasOwnProperty(b) ? d : a)[b];
        };
    }
    function ze(b, a, c) {
        return ea(b, c), ea(a, c), function(c, e) {
    ...
    function Fc(b, a, c) {
        ...
        if (a.unwrapPromises || 1 !== e) if (a.unwrapPromises || 2 !== e) if (a.csp) g = 6 > e ? Ec(d[0], d[1], d[2], d[3], d[4], c, a) : function(b, g) {
            var k, f = 0;
            do k = Ec(d[f++], d[f++], d[f++], d[f++], d[f++], c, a)(b, g), g = s, b = k; while (e > f);
            return k;
        }; else {
            var f = "var p;\n";
            q(d, function(b, d) {
            ...
            k.toString = $(f), g = a.unwrapPromises ? function(a, b) {
                return k(a, b, ta);
            } : k;
        } else g = ze(d[0], d[1], c); else g = ye(d[0], c);
        return "hasOwnProperty" !== b && (Sb[b] = g), g;
    }
    function Xd() {
        var b = {}, a = {
            csp: !1,
        ...
        this.unwrapPromises = function(b) {
            ...
            return a.csp = d.csp, ta = function(b) {
                ...
                switch (typeof d) {
                  case "string":
                    return b.hasOwnProperty(d) ? b[d] : (e = new Tb(a), e = new bb(e, c, a).parse(d), 
            ...
            return l = {
                ...
                promise: {
                    then: function(b, g, k) {
                        ...
                        return f ? f.push([ I, x, u ]) : h.then(I, x, u), l.promise;
                    },
                    "catch": function(a) {
    ...
    function Yd() {
        ...
        this.digestTtl = function(a) {
            ...
            function k() {
                this.$id = eb(), this.$$phase = this.$parent = this.$$watchers = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = null, 
            ...
            k.prototype = {
                ...
                $new: function(a) {
                    ...
                    a.$$postDigestQueue = this.$$postDigestQueue) : (this.$$childScopeClass || (this.$$childScopeClass = function() {
                        ...
                        this.$$listeners = {}, this.$$listenerCount = {}, this.$id = eb(), this.$$childScopeClass = null;
                ...
                $watchCollection: function(a, b) {
                    var d, e, f, c = this, k = 1 < b.length, h = 0, m = g(a), l = [], n = {}, p = !0, q = 0;
                    return this.$watch(function() {
                        d = m(c);
                        var a, b;
                        if (U(d)) if (db(d)) for (e !== l && (e = l, q = e.length = 0, h++), a = d.length, 
                        q !== a && (h++, e.length = q = a), b = 0; a > b; b++) e[b] !== e[b] && d[b] !== d[b] || e[b] === d[b] || (h++, 
                        e[b] = d[b]); else {
                            e !== n && (e = n = {}, q = 0, h++), a = 0;
                            for (b in d) d.hasOwnProperty(b) && (a++, e.hasOwnProperty(b) ? e[b] !== d[b] && (h++, 
                            e[b] = d[b]) : (q++, e[b] = d[b], h++));
                        ...
                        if (p ? (p = !1, b(d, d, c)) : b(d, f, c), k) if (U(d)) if (db(d)) {
                            f = Array(d.length);
                ...
                $digest: function() {
                    var d, g, f, k, q, z, P, w, E, A, h = this.$$asyncQueue, l = this.$$postDigestQueue, s = b, N = [];
                    m("$digest"), c = null;
                    do {
                        for (z = !1, P = this; h.length; ) {
                            try {
                        ...
                        a: do {
                            if (k = P.$$watchers) for (q = k.length; q--; ) try {
                                if (d = k[q]) if ((g = d.get(P)) === (f = d.last) || (d.eq ? xa(g, f) : "number" == typeof g && "number" == typeof f && isNaN(g) && isNaN(f))) {
                                    if (d === c) {
                                        z = !1;
                                        break a;
                                    }
                                } else z = !0, c = d, d.last = d.eq ? Ga(g, null) : g, d.fn(g, f === n ? g : f, P), 
                                5 > s && (w = 4 - s, N[w] || (N[w] = []), E = Q(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, 
                                E += "; newVal: " + ra(g) + "; oldVal: " + ra(f), N[w].push(E));
                            } catch (B) {
                                p.$$phase = null, e(B);
                            }
                ...
                $destroy: function() {
                    if (!this.$$destroyed) {
                        var a = this.$parent;
                        this.$broadcast("$destroy"), this.$$destroyed = !0, this !== p && (q(this.$$listenerCount, Ab(null, l, this)), 
                ...
                $on: function(a, b) {
                    ...
                    var e = this;
                    return function() {
                        c[Oa(c, b)] = null, l(e, 1, a);
                    };
                },
                $emit: function(a, b) {
                    var d, m, l, c = [], g = this, f = !1, k = {
                        name: a,
                        targetScope: g,
                        stopPropagation: function() {
                            f = !0;
                        ...
                        defaultPrevented: !1
                    }, h = [ k ].concat(ya.call(arguments, 1));
                    do {
                        for (d = g.$$listeners[a] || c, k.currentScope = g, m = 0, l = d.length; l > m; m++) if (d[m]) try {
                            d[m].apply(null, h);
                        } catch (n) {
                            e(n);
                ...
                $broadcast: function(a, b) {
                    for (var k, h, c = this, d = this, g = {
                        ...
                        for (g.currentScope = c, d = c.$$listeners[a] || [], k = 0, h = d.length; h > k; k++) if (d[k]) try {
                            d[k].apply(null, f);
                        } catch (m) {
                            e(m);
    ...
    function ae() {
        ...
        this.resourceUrlWhitelist = function(a) {
            ...
            var g = d(), f = {};
            return f[fa.HTML] = d(g), f[fa.CSS] = d(g), f[fa.URL] = d(g), f[fa.JS] = d(g), f[fa.RESOURCE_URL] = d(f[fa.URL]), 
            {
                ...
                getTrusted: function(c, d) {
                    ...
                    if (c === fa.RESOURCE_URL) {
                        var l, n, g = sa(d.toString()), p = !1;
                        for (l = 0, n = b.length; n > l; l++) if ("self" === b[l] ? Mb(g) : b[l].exec(g.href)) {
                            p = !0;
                            break;
                        }
                        if (p) for (l = 0, n = a.length; n > l; l++) if ("self" === a[l] ? Mb(g) : a[l].exec(g.href)) {
                            p = !1;
                            break;
                        }
                        if (p) return d;
    ...
    function $d() {
        ...
        this.enabled = function(a) {
            ...
            e.isEnabled = function() {
                ...
                return b;
            }, e.valueOf = Fa), e.parseAs = function(b, c) {
                var d = a(c);
    ...
    function be() {
        this.$get = [ "$window", "$document", function(b, a) {
            var k, c = {}, d = Z((/android (\d+)/.exec(L((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), g = a[0] || {}, f = g.documentMode, m = /^(Moz|webkit|O|ms)(?=[A-Z])/, h = g.body && g.body.style, l = !1, n = !1;
            if (h) {
                for (var p in h) if (l = m.exec(p)) {
                    k = l[0], k = k.substr(0, 1).toUpperCase() + k.substr(1);
                    break;
                }
                k || (k = "WebkitOpacity" in h && "webkit"), l = !!("transition" in h || k + "Transition" in h), 
                n = !!("animation" in h || k + "Animation" in h), !d || l && n || (l = C(g.body.style.webkitTransition), 
                n = C(g.body.style.webkitAnimation));
            }
            return {
    ...
    function Mb(b) {
        return b = C(b) ? sa(b) : b, b.protocol === Ic.protocol && b.host === Ic.host;
    }
    function ee() {
        this.$get = $(T);
    }
    function kc(b) {
        ...
        } ], a("currency", Jc), a("date", Kc), a("filter", Ce), a("json", De), a("limitTo", Ee), 
        a("lowercase", Fe), a("number", Lc), a("orderBy", Mc), a("uppercase", Ge);
    }
    function Ce() {
    ...
    function Jc(b) {
        ...
        return function(b, d) {
            return D(d) && (d = a.CURRENCY_SYM), Nc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(/\u00A4/g, d);
        };
    }
    function Lc(b) {
        var a = b.NUMBER_FORMATS;
    ...
    function Nc(b, a, c, d, e) {
        ...
        if (h) e > 0 && b > -1 && 1 > b && (k = b.toFixed(e)); else {
            f = (f.split(Oc)[1] || "").length, D(e) && (e = Math.min(Math.max(a.minFrac, f), a.maxFrac)), 
            f = Math.pow(10, e + 1), b = Math.floor(b * f + 5) / f, b = ("" + b).split(Oc), 
            f = b[0], b = b[1] || "";
            var l = 0, n = a.lgSize, p = a.gSize;
            if (f.length >= n + p) for (l = f.length - n, h = 0; l > h; h++) 0 === (l - h) % p && 0 !== h && (k += c), 
            k += f.charAt(h);
            for (h = l; h < f.length; h++) 0 === (f.length - h) % n && 0 !== h && (k += c), 
            k += f.charAt(h);
            for (;b.length < e; ) b += "0";
            e && "0" !== e && (k += d + b.substr(0, e));
        }
        return m.push(g ? a.negPre : a.posPre), m.push(k), m.push(g ? a.negSuf : a.posSuf), 
        m.join("");
    }
    function Ub(b, a, c) {
        var d = "";
    ...
    function Kc(b) {
        function a(a) {
            ...
            if (b = a.match(c)) {
                ...
                b[9] && (g = Z(b[9] + b[10]), f = Z(b[9] + b[11])), k.call(a, Z(b[1]), Z(b[2]) - 1, Z(b[3])), 
                g = Z(b[4] || 0) - g, f = Z(b[5] || 0) - f, k = Z(b[6] || 0), b = Math.round(1e3 * parseFloat("0." + (b[7] || 0))), 
                m.call(a, g, f, k, b);
            }
            return a;
        }
        ...
        return function(c, e) {
            var k, m, g = "", f = [];
            if (e = e || "mediumDate", e = b.DATETIME_FORMATS[e] || e, C(c) && (c = He.test(c) ? Z(c) : a(c)), 
            yb(c) && (c = new Date(c)), !Na(c)) return c;
            for (;e; ) (m = Ie.exec(e)) ? (f = f.concat(ya.call(m, 1)), e = f.pop()) : (f.push(e), 
            e = null);
            return q(f, function(a) {
                k = Je[a], g += k ? k(c, b.DATETIME_FORMATS) : a.replace(/(^'|'$)/g, "").replace(/''/g, "'");
            }), g;
        };
    }
    function De() {
    ...
    function Ee() {
        return function(b, a) {
            if (!O(b) && !C(b)) return b;
            if (a = 1 / 0 === Math.abs(Number(a)) ? Number(a) : Z(a), C(b)) return a ? a >= 0 ? b.slice(0, a) : b.slice(a, b.length) : "";
            var d, e, c = [];
    ...
    function Mc(b) {
        return function(a, c, d) {
            ...
            if (!O(a) || !c) return a;
            c = O(c) ? c : [ c ], c = Uc(c, function(a) {
                var c = !1, d = a || Fa;
                if (C(a) && (("+" == a.charAt(0) || "-" == a.charAt(0)) && (c = "-" == a.charAt(0), 
    ...
    function va(b) {
        return Q(b) && (b = {
            link: b
        }), b.restrict = b.restrict || "AC", $(b);
    }
    function Pc(b, a, c, d) {
        function e(a, c) {
            c = c ? "-" + hb(c, "-") : "", d.removeClass(b, (a ? tb : ub) + c), d.addClass(b, (a ? ub : tb) + c);
        }
        ...
        f.$addControl(g), b.addClass(Ma), e(!0), g.$addControl = function(a) {
            Aa(a.$name, "input"), h.push(a), a.$name && (g[a.$name] = a);
        }, g.$removeControl = function(a) {
            a.$name && g[a.$name] === a && delete g[a.$name], q(m, function(b, c) {
                g.$setValidity(c, !0, a);
            }), Pa(h, a);
        }, g.$setValidity = function(a, b, c) {
            var d = m[a];
            if (b) d && (Pa(d, c), d.length || (k--, k || (e(b), g.$valid = !0, g.$invalid = !1), 
            ...
            d.removeClass(b, Ma), d.addClass(b, wb), g.$dirty = !0, g.$pristine = !1, f.$setDirty();
        }, g.$setPristine = function() {
            d.removeClass(b, wb), d.addClass(b, Ma), g.$dirty = !1, g.$pristine = !0, q(h, function(a) {
                a.$setPristine();
            });
        };
    }
    ...
    function xb(b, a, c, d, e, g) {
        ...
        var l = function(e) {
            if (!h) {
                var g = a.val();
                S && "input" === (e || m).type && a[0].placeholder !== k ? k = a[0].placeholder : (Ra(c.ngTrim || "T") && (g = aa(g)), 
                (d.$viewValue !== g || f && "" === g && !f.valueMissing) && (b.$$phase ? d.$setViewValue(g) : b.$apply(function() {
                    d.$setViewValue(g);
                })));
            }
        };
        ...
        var r = c.ngPattern;
        if (r && ((e = r.match(/^\/(.*)\/([gim]*)$/)) ? (r = RegExp(e[1], e[2]), e = function(a) {
        ...
        return b = "ngClass" + b, [ "$animate", function(c) {
            ...
            return {
                ...
                link: function(g, f, k) {
                    ...
                    var l;
                    g.$watch(k[b], h, !0), k.$observe("class", function(a) {
                        h(g.$eval(k[b]));
    ...
    var S, w, Ba, Ua, La, L = function(b) {
        return C(b) ? b.toLowerCase() : b;
    }, zb = Object.prototype.hasOwnProperty, Ha = function(b) {
        return C(b) ? b.toUpperCase() : b;
    }, ya = [].slice, Le = [].push, wa = Object.prototype.toString, Qa = t("ng"), Sa = T.angular || (T.angular = {}), ja = [ "0", "0", "0" ];
    S = Z((/msie (\d+)/.exec(L(navigator.userAgent)) || [])[1]), isNaN(S) && (S = Z((/trident\/.*; rv:(\d+)/.exec(L(navigator.userAgent)) || [])[1])), 
    y.$inject = [], Fa.$inject = [];
    var O = function() {
    ...
    La = 9 > S ? function(b) {
        return b = b.nodeName ? b : b[0], b.scopeName && "HTML" != b.scopeName ? Ha(b.scopeName + ":" + b.nodeName) : b.nodeName;
    } : function(b) {
    ...
    q("input select option textarea button form details".split(" "), function(b) {
        ...
        attr: function(b, a, c) {
            var d = L(a);
            if (mb[d]) {
                if (!B(c)) return b[a] || (b.attributes.getNamedItem(a) || y).specified ? d : s;
        ...
        R.prototype[a] = function(a, d) {
            ...
            if (b !== pc && (2 == b.length && b !== Kb && b !== oc ? a : d) === s) {
                if (U(a)) {
                    for (e = 0; f > e; e++) if (b === nc) b(this[e], a); else for (g in a) b(this[e], g, a[g]);
                    return this;
                }
                for (e = b.$dv, f = e === s ? Math.min(f, 1) : f, g = 0; f > g; g++) {
                    var k = b(this[g], a, d);
                    e = e ? e + k : k;
                }
                return e;
            }
            for (e = 0; f > e; e++) b(this[e], a, d);
            return this;
        };
    }), q({
        removeData: lc,
        ...
        off: mc,
        one: function(a, c, d) {
            a = w(a), a.on(c, function g() {
                a.off(c, d), a.off(c, g);
            }), a.on(c, d);
        },
        replaceWith: function(a, c) {
            var d, e = a.parentNode;
            Ia(a), q(new R(c), function(c) {
    ...
    var pe = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, qe = /,/, re = /^\s*(_?)(\S+?)\1\s*$/, oe = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Za = t("$injector"), Me = t("$animate"), Ld = [ "$provide", function(a) {
        this.$$selectors = {}, this.register = function(c, d) {
            ...
            return {
                enter: function(a, c, f, k) {
                    f ? f.after(a) : (c && c[0] || (c = f.parent()), c.append(a)), k && d(k);
                },
                leave: function(a, c) {
                    a.remove(), c && d(c);
                },
                ...
                addClass: function(a, c, f) {
                    c = C(c) ? c : O(c) ? c.join(" ") : "", q(a, function(a) {
                        kb(a, c);
                    }), f && d(f);
                },
    ...
    Rb.prototype = Qb.prototype = Cc.prototype = {
        ...
        search: function(a, c) {
            switch (arguments.length) {
              ...
              case 1:
                if (C(a)) this.$$search = cc(a); else {
                    if (!U(a)) throw Pb("isrcharg");
                    this.$$search = a;
                }
                break;
    ...
    Tb.prototype = {
        constructor: Tb,
        lex: function(a) {
            for (this.text = a, this.index = 0, this.ch = s, this.lastCh = ":", this.tokens = []; this.index < this.text.length; ) {
        ...
        readIdent: function() {
            for (var e, g, f, k, a = this, c = "", d = this.index; this.index < this.text.length && (k = this.text.charAt(this.index), 
            "." === k || this.isIdent(k) || this.isNumber(k)); ) "." === k && (e = this.index), 
            c += k, this.index++;
            if (e) for (g = this.index; g < this.text.length; ) {
                if (k = this.text.charAt(g), "(" === k) {
            ...
            if (d = {
                index: d,
                text: c
            }, cb.hasOwnProperty(c)) d.fn = cb[c], d.literal = !0, d.constant = !0; else {
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, g = !1; this.index < this.text.length; ) {
                ...
                this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Oe[f]) ? d + g : d + f, 
    ...
    bb.ZERO = J(function() {
        ...
        objectIndex: function(a) {
            ...
            return this.consume("]"), J(function(e, g) {
                var m, f = a(e, g), k = d(e, g);
                return f ? ((f = ab(f[k], c.text)) && f.then && c.options.unwrapPromises && (m = f, 
                "$$v" in f || (m.$$v = s, m.then(function(a) {
                    m.$$v = a;
                })), f = f.$$v), f) : s;
            }, {
        ...
        functionCall: function(a, c) {
            ...
            return function(g, f) {
                ...
                return h = a(g, f, m) || y, ab(m, e.text), ab(h, e.text), k = h.apply ? h.apply(m, k) : h(k[0], k[1], k[2], k[3], k[4]), 
                ab(k, e.text);
            };
        },
        arrayDeclaration: function() {
            ...
            return this.consume("]"), J(function(c, d) {
    ...
    kc.$inject = [ "$provide" ], Jc.$inject = [ "$locale" ], Lc.$inject = [ "$locale" ];
    var Oc = ".", Je = {
        yyyy: Y("FullYear", 4),
        yy: Y("FullYear", 2, 0, !0),
        y: Y("FullYear", 1),
        ...
        Z: function(a) {
            return a = -1 * a.getTimezoneOffset(), a = (a >= 0 ? "+" : "") + (Ub(Math[a > 0 ? "floor" : "ceil"](a / 60), 2) + Ub(Math.abs(a % 60), 2));
        }
    ...
    var cd = $({
        ...
        compile: function(a, c) {
            return 8 >= S && (c.href || c.name || c.$set("href", ""), a.append(V.createComment("IE fix"))), 
    ...
    q(mb, function(a, c) {
        ...
        Eb[c] = function() {
            return {
                ...
                link: function(d, e, g) {
                    var f = a, k = a;
                    "href" === a && "[object SVGAnimatedString]" === wa.call(e.prop("href")) && (k = "xlinkHref", 
                    g.$attr[k] = "xlink:href", f = null), g.$observe(c, function(a) {
    ...
    var Qc = function(a) {
                    ...
                    return {
                        pre: function(a, e, g, f) {
                            if (!g.action) {
                                ...
                                pb(e[0], "submit", k), e.on("$destroy", function() {
                                    c(function() {
                                        Wa(e[0], "submit", k);
                                    }, 0, !1);
                                });
                            ...
                            h && rb(a, h, f, h), m && e.on("$destroy", function() {
                                m.$removeControl(f), h && rb(a, h, s, h), J(f, vb);
                            });
                        }
                    };
                }
        ...
        number: function(a, c, d, e, g, f) {
            xb(a, c, d, e, g, f), e.$parsers.push(function(a) {
                var c = e.$isEmpty(a);
                return c || Re.test(a) ? (e.$setValidity("number", !0), "" === a ? null : c ? a : parseFloat(a)) : (e.$setValidity("number", !1), 
                s);
            }), Ke(e, "number", c), e.$formatters.push(function(a) {
                ...
                return qa(e, "max", e.$isEmpty(a) || c >= a, a);
        ...
        radio: function(a, c, d, e) {
            D(d.name) && c.attr("name", eb()), c.on("click", function() {
        ...
        checkbox: function(a, c, d, e) {
            ...
            C(g) || (g = !0), C(f) || (f = !1), c.on("click", function() {
                a.$apply(function() {
        ...
        function k(a, c) {
            c = c ? "-" + hb(c, "-") : "", f.removeClass(e, (a ? tb : ub) + c), f.addClass(e, (a ? ub : tb) + c);
        }
        ...
        e.addClass(Ma), k(!0), this.$setValidity = function(a, c) {
            p[a] !== !c && (c ? (p[a] && n--, n || (k(!0), this.$valid = !0, this.$invalid = !1)) : (k(!1), 
            this.$invalid = !0, this.$valid = !1, n++), p[a] = !c, k(c, a), l.$setValidity(a, c, this));
        }, this.$setPristine = function() {
            this.$dirty = !1, this.$pristine = !0, f.removeClass(e, wb), f.addClass(e, Ma);
        }, this.$setViewValue = function(d) {
            this.$viewValue = d, this.$pristine && (this.$dirty = !0, this.$pristine = !1, f.removeClass(e, Ma), 
            f.addClass(e, wb), l.$setDirty()), q(this.$parsers, function(a) {
                d = a(d);
        ...
        compile: function(a) {
            return a.addClass("ng-binding"), function(a, d, e) {
    ...
    var sd = [ "$animate", function(a) {
            ...
            link: function(c, d, e, g, f) {
                ...
                c.$watch(e.ngIf, function(g) {
                    Ra(g) ? m || (m = c.$new(), f(m, function(c) {
                        c[c.length++] = V.createComment(" end ngIf: " + e.ngIf + " "), k = {
                            clone: c
                        }, a.enter(c, d.parent(), d);
                    })) : (h && (h.remove(), h = null), m && (m.$destroy(), m = null), k && (h = Db(k.clone), 
                    a.leave(h, function() {
                        h = null;
                    }), k = null));
                });
        ...
        return {
            ...
            compile: function(f, k) {
                ...
                return function(f, k, r, q, I) {
                    var u, w, F, s = 0, z = function() {
                        w && (w.remove(), w = null), u && (u.$destroy(), u = null), F && (e.leave(F, function() {
                            w = null;
                        }), w = F, F = null);
                    };
                    f.$watch(g.parseAsResourceUrl(m), function(g) {
                        ...
                        g ? (a.get(g, {
                            ...
                            if (r === s) {
                                var c = f.$new();
                                q.template = a, a = I(c, function(a) {
                                    z(), e.enter(a, null, k, m);
                                }), u = c, F = a, u.$emit("$includeContentLoaded"), f.$eval(h);
                            }
                        }).error(function() {
                            r === s && z();
        ...
        return {
            ...
            link: function(e, g, f) {
                ...
                q(f, function(a, c) {
                    ...
                    return isNaN(c) ? "" : (c in l || (c = a.pluralCat(c - h)), n[c](e, g, !0));
                }, function(a) {
                    g.text(a);
                });
            }
        ...
        return {
            ...
            link: function(e, g, f, k, m) {
                var n, p, r, s, I, x, h = f.ngRepeat, l = h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), u = {
                    $id: Ja
                };
                if (!l) throw d("iexp", h);
                if (f = l[1], k = l[2], (l = l[3]) ? (n = a(l), p = function(a, c, d) {
                    return x && (u[x] = a), u[I] = c, u.$index = d, n(e, u);
                }) : (r = function(a, c) {
                    return Ja(c);
                }, s = function(a) {
                    return a;
                }), l = f.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/), !l) throw d("iidexp", f);
                I = l[3] || l[1], x = l[2];
                var B = {};
                e.$watchCollection(k, function(a) {
                    var f, k, n, E, A, H, t, C, y, l = g[0], u = {}, D = [];
                    if (db(a)) C = a, n = p || r; else {
                        n = p || s, C = [];
                        for (H in a) a.hasOwnProperty(H) && "$" != H.charAt(0) && C.push(H);
                        C.sort();
                    }
                    for (E = C.length, k = D.length = C.length, f = 0; k > f; f++) if (H = a === C ? f : C[f], 
                    t = a[H], t = n(H, t, f), Aa(t, "`track by` id"), B.hasOwnProperty(t)) y = B[t], 
                    delete B[t], u[t] = y, D[f] = y; else {
                    ...
                    for (f = 0, k = C.length; k > f; f++) {
                        if (H = a === C ? f : C[f], t = a[H], y = D[f], D[f - 1] && (l = D[f - 1].clone[D[f - 1].clone.length - 1]), 
                        y.scope) {
                            A = y.scope, n = l;
                            do n = n.nextSibling; while (n && n.$$NG_REMOVED);
                            y.clone[0] != n && c.move(Db(y.clone), null, w(l)), l = y.clone[y.clone.length - 1];
                        } else A = e.$new();
                        A[I] = t, x && (A[x] = H), A.$index = f, A.$first = 0 === f, A.$last = f === E - 1, 
                        A.$middle = !(A.$first || A.$last), A.$odd = !(A.$even = 0 === (1 & f)), y.scope || m(A, function(a) {
                            a[a.length++] = V.createComment(" end ngRepeat: " + h + " "), c.enter(a, null, w(l)), 
                            l = a, y.scope = A, y.clone = a, u[y.id] = y;
                        });
                    }
                    B = u;
                });
            ...
            link: function(c, d, e, g) {
                ...
                c.$watch(e.ngSwitch || e.on, function(d) {
                    ...
                    for (n = m.length = 0, p = h.length; p > n; ++n) {
                        var r = k[n];
                        h[n].$destroy(), m[n] = r, a.leave(r, function() {
                            m.splice(n, 1);
                        });
                    }
                    k.length = 0, h.length = 0, (f = g.cases["!" + d] || g.cases["?"]) && (c.$eval(e.change), 
                    q(f, function(d) {
                        var e = c.$new();
        ...
        return {
            ...
            controller: [ "$element", "$scope", "$attrs", function(a, c, d) {
                ...
                m.databound = d.ngModel, m.init = function(a, c, d) {
                    ...
                    Aa(c, '"option value"'), h[c] = !0, l.$viewValue == c && (a.val(c), n.parent() && n.remove());
                    ...
                    c = "? " + Ja(c) + " ?", n.val(c), a.prepend(n), a.val(c), n.prop("selected", !0);
            ...
            link: function(e, f, k, m) {
                function h(a, c, d, e) {
                    d.$render = function() {
                        ...
                        a.$apply(function() {
                            F.parent() && F.remove(), d.$setViewValue(c.val());
                        });
                    });
                }
                function l(a, c, d) {
                ...
                function n(e, f, g) {
                    function k() {
                        ...
                        t = g.$modelValue, v = w(e) || [];
                        var F, K, A, D = n ? Wb(v) : v;
                        K = {}, s = !1;
                        var E, J;
                        if (r) if (x && O(t)) for (s = new Ya([]), A = 0; A < t.length; A++) K[m] = t[A], 
                        s.put(x(e, K), t[A]); else s = new Ya(t);
                        for (A = 0; F = D.length, F > A; A++) {
                            if (h = A, n) {
                                if (h = D[A], "$" === h.charAt(0)) continue;
                                K[n] = h;
                            }
                            K[m] = v[h], d = p(e, K) || "", (h = a[d]) || (h = a[d] = [], c.push(d)), r ? d = B(s.remove(x ? x(e, K) : q(e, K))) : (x ? (d = {}, 
                            d[m] = t, d = x(e, d) === x(e, K)) : d = t === q(e, K), s = s || d), E = l(e, K), 
                            E = B(E) ? E : "", h.push({
                                id: x ? x(e, K) : n ? D[A] : A,
                                label: E,
                                selected: d
                        ...
                        for (r || (y || null === t ? a[""].unshift({
                            ...
                            label: "",
                            selected: !0
                        })), K = 0, D = c.length; D > K; K++) {
                            for (d = c[K], h = a[d], z.length <= K ? (t = {
                                element: C.clone().attr("label", d),
                                label: h.label
                            }, v = [ t ], z.push(v), f.append(t.element)) : (v = z[K], t = v[0], t.label != d && t.element.attr("label", t.label = d)), 
                            E = null, A = 0, F = h.length; F > A; A++) s = h[A], (d = v[A + 1]) ? (E = d.element, 
                            d.label !== s.label && E.text(d.label = s.label), d.id !== s.id && E.val(d.id = s.id), 
                            d.selected !== s.selected && E.prop("selected", d.selected = s.selected)) : ("" === s.id && y ? J = y : (J = u.clone()).val(s.id).attr("selected", s.selected).text(s.label), 
                            v.push({
                                element: J,
                                label: s.label,
                                id: s.id,
                    ...
                    y && (a(y)(e), y.removeClass("ng-scope"), y.remove()), f.empty(), f.on("change", function() {
                        e.$apply(function() {
                            var a, h, k, l, p, t, u, v, c = w(e) || [], d = {};
                            if (r) {
                                for (k = [], p = 0, u = z.length; u > p; p++) for (a = z[p], l = 1, t = a.length; t > l; l++) if ((h = a[l].element)[0].selected) {
                                    if (h = h.val(), n && (d[n] = h), x) for (v = 0; v < c.length && (d[m] = c[v], x(e, d) != h); v++) ; else d[m] = c[h];
                                    k.push(q(e, d));
                                }
                            } else {
                                if (h = f.val(), "?" == h) k = s; else if ("" === h) k = null; else if (x) {
                                    for (v = 0; v < c.length; v++) if (d[m] = c[v], x(e, d) == h) {
                                        k = q(e, d);
                                        break;
                                    }
                ...
                if (m[1]) {
                    var p = m[0];
                    m = m[1];
                    var x, r = k.multiple, t = k.ngOptions, y = !1, u = w(V.createElement("option")), C = w(V.createElement("optgroup")), F = u.clone();
                    k = 0;
                    for (var z = f.children(), J = z.length; J > k; k++) if ("" === z[k].value) {
                        x = y = z.eq(k);
                        break;
                    }
                    p.init(m, y, F), r && (m.$isEmpty = function(a) {
                        return !a || 0 === a.length;
        ...
        return {
            ...
            compile: function(d, e) {
                ...
                return function(a, d, e) {
                    ...
                    l && l.databound ? d.prop("selected", !1) : l = c, g ? a.$watch(g, function(a, c) {
    ...
    T.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : ((Ba = T.jQuery) && Ba.fn.on ? (w = Ba, 
    J(Ba.fn, {
        scope: Ka.scope,
    ...
    }), Fb("remove", !0, !0, !1), Fb("empty", !1, !1, !1), Fb("html", !1, !1, !0)) : w = R, 
    Sa.element = w, Zc(Sa), w(V).ready(function() {
        Wc(V, dc);
    }));
...
var mq, mediaQuery = mqType().width;

mqCheck(), doMq(), $(window).resize(function() {
    mediaQuery = mqType().width, mqCheck(), doMq();
}), jQuery("body").on("click", ".toggleNext", function(e) {
    e.preventDefault(), jQuery(this).next().toggleClass("hide"), jQuery(this).find("i").toggleClass("fa-caret-down").toggleClass("fa-caret-up");
}), mobileNavInit(), function(i, s, o, g, r, a, m) {
    i.GoogleAnalyticsObject = r, i[r] = i[r] || function() {
        (i[r].q = i[r].q || []).push(arguments);
    }, i[r].l = 1 * new Date(), a = s.createElement(o), m = s.getElementsByTagName(o)[0], 
    a.async = 1, a.src = g, m.parentNode.insertBefore(a, m);
}(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), 
ga("create", "UA-68350548-1", "auto"), ga("send", "pageview"), angular.module("replaceRetina", []).directive("replaceRetina", function() {
    return function(element) {
        window.devicePixelRatio > 1 && document.body.clientWidth > 1200 && angular.element(".retina-replace").each(function() {
            var imageSrc = "", newSrc = "", iHeight = angular.element(this).attr("data-height");
            0 === angular.element(this).attr("src").length ? (imageSrc = angular.element(".retina-replace").attr("data-src"), 
            newSrc = imageSrc.split("."), newSrc = newSrc[0] + ".x2." + newSrc[1], angular.element(this).attr("data-src", newSrc).css({
                height: iHeight
            })) : (imageSrc = angular.element(".retina-replace").attr("src"), newSrc = imageSrc.split("."), 
            newSrc = newSrc[0] + ".x2." + newSrc[1], angular.element(this).attr("src", newSrc).css({
                height: iHeight
            })), angular.element(this).removeClass("retina-replace");
        });
    };
}), angular.module("onScroll", []).directive("onScroll", function($window) {
    return function(scope, element, attrs) {
        var threshold = element.attr("data-threshold");
        threshold > 0 || (threshold = 100), angular.element($window).bind("scroll", function() {
            this.pageYOffset >= element.offset().top - threshold && 0 === element.attr("src").length && element.attr("src", element.attr("data-src")), 
            scope.$apply();
        });
    };
}), angular.module("scrollToTop", []).directive("scrollToTop", function($window) {
    return function(scope, element, attrs) {
        angular.element($window).bind("scroll", function() {
            this.pageYOffset >= 100 ? element.removeClass("hide") : element.addClass("hide");
...
}), angular.module("replaceSvg", []).directive("replaceSvg", function() {
    return function(element) {
        angular.element("html").hasClass("svg") || (console.log("old ie"), angular.element(".svg-replace").each(function() {
...
aaeApp.controller("aaeController", function($scope, $rootScope, $timeout) {
    ...
    var d = new Date();
    $rootScope.date = d.getFullYear(), $http.get("js/getNearByStores.json").success(function(data, status, headers, config) {
        $scope.stores = data.stores, $scope.storesByState = data, googleMapService.initMap($scope, "geocode"), 
        $timeout(function() {
            jQuery('[data-toggle="popover"]').popover();
        }, 500), $scope.listVisible = !1;
        ...
        $scope.listVisible = !0, googleMapService.initMap($scope, location), $timeout(function() {
            for (i = 0; i < $scope.stores.length; i++) {
                var lat1 = parseFloat($scope.stores[i].latitude), lon1 = parseFloat($scope.stores[i].longitude), lat2 = $scope.yourLat, lon2 = $scope.yourLng, R = 3959, dLat = toRad(lat2 - lat1), dLon = toRad(lon2 - lon1), a = Math.sin(dLat / 2) * Math.sin(dLat / 2) + Math.cos(toRad(lat2)) * Math.cos(toRad(lat1)) * Math.sin(dLon / 2) * Math.sin(dLon / 2), c = 2 * Math.atan2(Math.sqrt(a), Math.sqrt(1 - a)), distance = R * c;
                $scope.stores[i].distance = Math.round(distance);
            }
        }, 500);
    }, $scope.setCity = function(city) {
        $scope.listTyping = !1, $scope.stateFilter = city;
        ...
        jQuery(".stateListWrapper").each(function() {
            jQuery(this).find(".storeInfo").length ? jQuery(this).removeClass("hide") : jQuery(this).addClass("hide");
        });
    ...
    var d = new Date();
    $rootScope.date = d.getFullYear(), $scope.category = "Browse Our", $scope.kcURL = "/views/kc-landing.html", 
    $scope.setTitle = function(category, url) {
        $scope.category = category, $scope.kcURL = url;
    }, $scope.setLanding = function() {
        $scope.category = "Browse Our", $scope.kcURL = "/views/kc-landing.html";
    };
});
...
aaeApp.factory("googleMapService", function($http, $timeout) {
    return {
        initMap: function(scope, location) {
            ...
            navigator.geolocation && "geocode" === location || "current location" === location || "Current Location" === location ? navigator.geolocation.getCurrentPosition(function(position) {
                var pos = new google.maps.LatLng(position.coords.latitude, position.coords.longitude);
                map.setCenter(pos), map.setZoom(9);
                new google.maps.Marker({
                    position: pos,
                    map: map,
                    icon: "images/currentLocation-marker.png"
                });
                angular.element(".storeListContainer").toggleClass("hide"), angular.element(".searchContainer").toggleClass("hide"), 
                scope.yourLat = position.coords.latitude, scope.yourLng = position.coords.laongitude, 
                scope.getLocation(position.coords.latitude + " " + position.coords.longitude);
            }) : $http.get("http://maps.googleapis.com/maps/api/geocode/json?address=" + location + "&sensor=true").success(function(data) {
                var pos = new google.maps.LatLng(data.results[0].geometry.location.lat, data.results[0].geometry.location.lng);
                scope.yourLat = data.results[0].geometry.location.lat, scope.yourLng = data.results[0].geometry.location.lng, 
                map.setCenter(pos), map.setZoom(9);
                new google.maps.Marker({
                    position: pos,
                    map: map,
            ...
            var marker, i, data = scope.stores, infoWindow = new google.maps.InfoWindow();
            for (i = 0; i < data.length; i++) {
                ...
                marker = new google.maps.Marker({
                    ...
                    return function() {
                        infoWindow.setContent('<div style="width: 440px;"><a target="_blank" class="btn btn-default pull-right" href="http://maps.apple.com/?saddr=Current%20Location&daddr=' + data[i].streetAddr + data[i].city + data[i].zipCode + '">Get Directions</a><h2><strong>' + data[i].storeName + '</strong></h2><span class="dullGray">Store #' + data[i].storeUnit + '</span><br><aside class="mapInfoWrap lh-standard">' + data[i].streetAddr + ", " + data[i].city + ", " + data[i].state + " " + data[i].zipCode + "<br>Phone: " + data[i].phone + '<br><br><a class="btn btn-info pull-right" target="_blank" href="http://www.searshometownstores.com/locations/' + data[i].urlFriendlyName + "-" + data[i].state + '">Shop Store Inventory</a><strong class="dark toggleNext">Store Hours <i class="fa fa-caret-down"></i></strong><aside class="hide"><strong class="col-xs-2 text-right">Mon:</strong> ' + data[i].monHours + '<br><strong class="col-xs-2 text-right">Tue:</strong> ' + data[i].tueHours + '<br><strong class="col-xs-2 text-right">Wed:</strong> ' + data[i].wedHours + '<br><strong class="col-xs-2 text-right">Thr:</strong> ' + data[i].thrHours + '<br><strong class="col-xs-2 text-right">Fri:</strong> ' + data[i].friHours + '<br><strong class="col-xs-2 text-right">Sat:</strong> ' + data[i].satHours + '<br><strong class="col-xs-2 text-right">Sun:</strong> ' + data[i].sunHours + "<br></aside></div>"), 
                        infoWindow.open(map, marker), map.setCenter(marker.getPosition());
                    };
                }(marker, i));
            }
            angular.element("body").on("click", "#storeLocatorListWrapper li", function() {
                angular.element(this).index();
            });
        },
